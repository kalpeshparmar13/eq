        ...
        <div class="grid gap-4 sm:grid-cols-2 md:grid-cols-4 mb-6">
            ...
            <!-- <div>
                ...
                <label class="inline-flex items-center me-5 cursor-pointer">
                    <input type="checkbox" id="is_on_duty" class="sr-only peer" onchange="toggleDutyStatus()">
                    ...
                    <span name="is_on_duty" id="duty_status_text" class="ms-3 text-sm font-medium text-gray-900 dark:text-gray-300">No</span>
                </label>
            </div> -->
        </div>
